      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/home" className="flex items-center gap-3 group">
            <div className={`w-9 h-9 bg-orange-500 flex items-center justify-center transition-transform duration-300 group-hover:scale-110`}>
          ...
          <div className="flex items-center gap-3">
            ...
            {isLoggedIn ? (
              <>
                ...
                <Link
                  to="/upload"
                  className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 font-semibold transition-all duration-200 flex items-center gap-2 hover:scale-105 active:scale-95"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="relative">
                  ...
                  {/* Dropdown Menu */}
                  {showDropdown && (
                    <div className={`absolute right-0 mt-2 w-64 border shadow-2xl py-2 ${
                      isDark 
                      ...
                      <Link
                        ...
                        className={`block px-4 py-3 transition-colors ${
                          isDark ? 'hover:bg-neutral-800 text-neutral-300' : 'hover:bg-neutral-50 text-neutral-700'
                        }`}
