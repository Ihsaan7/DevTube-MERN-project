...
import { getLikedVideos } from "../api/services/like.services";
...
const LikedVideosPage = () => {
  ...
  const fetchLikedVideos = async () => {
    try {
      ...
      // Backend returns paginated result { docs: [{ video: {...}, likedAt }], ... }
      const likedVideos = response.data?.docs?.map((item) => item.video) || [];
